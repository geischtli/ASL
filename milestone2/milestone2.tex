...
\begin{center}
	\captionof{table}{M/M/[40 and 42] Model on Scalability Data for 2 Middlewares}
...
\TwoFig	{figures/max_tp_2/tp} {Throughput of the whole system} {fig:max_tp_tp}
		{figures/interactive_law/max_tp_2} {Response time of the whole system} {fig:max_tp_rt}
