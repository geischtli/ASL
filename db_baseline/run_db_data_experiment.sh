...
while [  $CURR_DB_CONNECTIONS -le $END_DB_CONNECTIONS ]; do
	...
	# delete all log files generated by this pgbench
	rm -rf ./p*
	...
	# copy all log files into a experiment folder
	mkdir level_2_$CURR_DB_CONNECTIONS
	
	mv ./p* level_2_$CURR_DB_CONNECTIONS
