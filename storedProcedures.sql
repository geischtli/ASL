...
CREATE OR REPLACE FUNCTION clear_the_database()
	RETURNS INTEGER AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION create_sequence_middleware()
	RETURNS INTEGER AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION create_message_table(content_size INTEGER)
	RETURNS INTEGER AS $$
BEGIN
