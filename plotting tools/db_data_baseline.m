...
% create legend
legend('remove top message 50% quantile', ...
    'insert 10 new messages 50% quantile', ...
    'size of message table 50% quantile', 'Location', 'northwest')
xlabel('10^-1 seconds (10-second intervals)')
ylabel('Time needed to complete action (ms)')
title('Database behaviour with data')
...
hNewAxes = axes('Position', axesPosition,...
                ...
                'YTick', [1 2 3 4 5 6 7], ...
                'Box', 'off');
ylabel(hNewAxes,'Message Table size * 10^5(# of entries)');