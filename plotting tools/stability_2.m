...
total_rt_per_request = zeros(60, 1);
total_thinktime_per_request = zeros(60, 1);
total_tp = zeros(60, 1);
...
legend('mw rt', 'db plust network', 'wait for db conn', 'client rt')